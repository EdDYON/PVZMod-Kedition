 ...
 * @author Author
 */
public class RepeaterModelAnimation {
    ...
    public static final AnimationDefinition shoot = AnimationDefinition.Builder.withLength(1.5F).looping()
            ...
            .addAnimation("bone4", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(1.375F, KeyframeAnimations.posVec(-0.4F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.5F, KeyframeAnimations.posVec(0.0F, 0.0F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
            ...
            .addAnimation("bone5", new AnimationChannel(AnimationChannel.Targets.POSITION,
                    ...
                    new Keyframe(0.8333F, KeyframeAnimations.posVec(-0.3F, 1.5F, 0.0F), AnimationChannel.Interpolations.CATMULLROM),
                    new Keyframe(1.0F, KeyframeAnimations.posVec(-0.4968F, 6.8627F, 0.0F), AnimationChannel.Interpolations.CATMULLROM)
            ))
