...
public class TallNutModel1 extends HierarchicalModel<EntityTallnut> {
    // This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
    public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation(PVZMod.MODID, "textures/entity/plant/tallnut_new_1"), "main");
    ...
    public TallNutModel1(ModelPart root) {
        this.root = root;
    ...
    public static LayerDefinition createBodyLayer() {
        ...
        PartDefinition eye = face.addOrReplaceChild("eye", CubeListBuilder.create().texOffs(67, 3).addBox(-4.9167F, -1.0833F, -2.0083F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0001F))
                .texOffs(59, 3).addBox(1.0833F, -1.0833F, -2.0083F, 4.0F, 2.0F, 0.0F, new CubeDeformation(0.0001F)), PartPose.offset(-0.0833F, -11.8982F, 2.0083F));
    ...
    public void setupAnim(EntityTallnut entity, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        ...
        this.animate(entity.idleAnimation1, TallNutAnimation0.animation, ageInTicks, 1.0F);
